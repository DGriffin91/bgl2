...
impl<T: Copy + Default + PartialEq, const STACK_SIZE: usize> PartialEq
    for StackStack<T, STACK_SIZE>
{
    fn eq(&self, other: &Self) -> bool {
        self.index == other.index && self.data[0..self.index] == other.data[0..other.index]
    }
}
